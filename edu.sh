...
wget -q -O /usr/local/bin/edu-ssh https://raw.githubusercontent.com/santzx45/anu/main/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/santzx45/anu/main/edu-op.py
