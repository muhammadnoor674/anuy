...
#xray-vless-xtls
                ...
                "fallbacks": [
                    ...
                    {
                        "path": "/bz-vlesswstls", # // VMESS WS TLS
                        "dest": 1212,
                        "xver": 1
                    },
                    {
                        "path": "/bz-vmesswstls", # // VLESS WS TLS
                        "dest": 1213,
                        "xver": 1
                    },
                    {
                        "path": "/bz-trojanwstls", # // TROJAN WS TLS
                        "dest": 1214,
                        "xver": 1
                    }
                ]
  ...
  "inbounds": [
      ...
      "settings": {
        ...
        "fallbacks": [
          ...
          {
            "path": "/bz-vlesswsntls", # // VLESS NONE
            "dest": 1301,
            "xver": 1
          },
          {
            "path": "/bz-vmesswsntls", # // VMESS NONE
            "dest": 1302,
            "xver": 1
          },
          {
             "path": "/bz-trojanwsntls", # // TROJAN NONE
            "dest": 1303,
            "xver": 1
          }
        ]
